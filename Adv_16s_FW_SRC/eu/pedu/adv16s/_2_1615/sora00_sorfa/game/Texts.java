...
//== CONSTANT CLASS ATTRIBUTES =================================================
  ...
  MANZELSKA_POSTEL          = "Manželská-postel",
    ...
    static final String
            ...
            zTANCUJ_HOLCICKA =
            "Holčičce se taneček velice líbil, zatleskala vám a přitom jí\n" +
            ...
            "Bohužel jste selhal, váš úkol zůstal nesplněn. Tak snad nědky\n" +
            "příště :)",
            zALTERNATIVE_END =
            ...
            "Jak po čase vyplynulo z pátrání biologů. Maminka byla nakažena\n" +
            ...
            "velice spokojeně. Na oplátku vám za to věnovala vysavač s \n" +
            "obrázkem sloníka\nZískáváte vysavač",
            ...
            "pěti zlatých cihel a papírů, objevujete podivnou ampulku s\n" +
            ...
            "vidíte podivně vyhlížející igelitový sáček. Po otevření \n" +
            ...
            "raději zapomněl, že ste je kdy viděl nacházíte zlatý řetízek a\n" +
            "svazek bankovek",
            zPROZKOUMEJ_OBRAZ =
            "Podíval jste se na obraz z blízka a něco vám na něm nesedělo.\n" +
            "Podíval jste se za něj a spatřil jste malé kovové panty. Pohnul\n"+
            ...
            "jedné z nich na vás vypadl malinký podivný papírek. Z jedné\n" +
            ...
            zZKOMBINUJ_NEZADAN = "Nevím co mám zkombinovat, zadej prosím dvě " +
            "věci a já to skusím znovu",
            zZKOMBINUJ_NENI_V_BATOHU = "Nemůžu a nechci montovat to co nemám.",
            zZKOMBINUJ_NENI_KOMBINACE = "Hmm... z toho nic zajímavého nezískám",
            ...
            "jste si improvizovaný výkonný rozprašovač. Stačí ještě sehnat\n" +
    ...
    static final String
            ...
            "potenciálně mohla zničit svět.",
            wCHODBA =
            "Odsud je možné navštívit spoustu dalších místností, nebo\n" +
            "sejít dolů po schodech. Kromě obrazu na stěně tu není nic\n" +
            "dalšího k vidění.",
            wKOUPELNA =
            "Hmmmm... tohle je nádherná koupelna, je tu naprosto vše, co\n"+
            "by mohlo posloužit k výtečné vraždě, jako z hollywoodského\n" +
            "hororu. Na první pohled ovšem nic nenormálního. Při \n" +
            ...
            "strýček Alfréd na to vypadá",
            wKUMBAL =
            "Kumbál patrně slouží jako sklad úklidových pomůcek, je to\n" +
            ...
            "okolností jste rád, že vůbec dokážete jít rovně.",
            wOBYVAK =
            ...
            wKUCHYN =
            "V kuchyni vidíte maminku a tatínka, patrně se pokoušejí\n" +
            ...
            "nablýskaný sportovní vůz značky Porsche. Auto je však\n" +
            "zamčené a se svojí velikostí byste se stejně moc daleko\n" +
